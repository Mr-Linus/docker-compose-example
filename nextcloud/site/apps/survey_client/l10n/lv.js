OC.L10N.register(
    ...
    "PHP environment <em>(version, memory limit, max. execution time, max. file size)</em>" : "PHP vide <em>(versija, atmiņas limits, max. izpildes laiks, max. faila izmērs)</em>",
    "Statistic <em>(number of: files, users, storages per type, comments and tags)</em>" : "Statistika <em>(skaits: failu, lietotāju, krātuves pēc tipa, komentāri un birkas)</em>",
